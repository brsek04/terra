...
var maxSidebar = document.querySelector(".max");
var miniSidebar = document.querySelector(".mini");
var roundout = document.querySelector(".roundout");
var maxToolbar = document.querySelector(".max-toolbar");
