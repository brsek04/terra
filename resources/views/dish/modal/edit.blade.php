...
<div id="popup-edit-{{$dish->id}}" aria-hidden="true" class="fixed hidden overflow-y-auto overflow-x-hidden top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full" tabindex="-1">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 px-5 py-4">
            ...
            <form action="{{ route('dishes.update', $dish->id) }}" method="POST"  enctype="multipart/form-data" class="p-2">
                {{ method_field('PATCH') }}
                @csrf
                <div class="grid gap-4 pb-5 grid-cols-2">
                    <div class="col-span-2 pt-5">
                        ...
                        {{ Form::text('name', $dish->name, ['class' => 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500' . ($errors->has('name') ? ' is-invalid' : ''), 'placeholder' => 'Nombre']) }}
                        {!! $errors->first('name', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    <div class="col-span-2 pt-5">
                        {{ Form::label('Descripcion', null, ['class' => 'block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left']) }}
                        {{ Form::text('description', $dish->description, ['class' => 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500' . ($errors->has('description') ? ' is-invalid' : ''), 'placeholder' => 'Descripcion']) }}
                        {!! $errors->first('description', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    <div class="col-span-2 pt-5">
                        {{ Form::label('Precio', null, ['class' => 'block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left']) }}
                        {{ Form::text('price', $dish->price, ['class' => 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500' . ($errors->has('price') ? ' is-invalid' : ''), 'placeholder' => 'Precio']) }}
                        {!! $errors->first('price', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    <div class="col-span-2 pt-5">
                        {{ Form::label('Valoracion', null, ['class' => 'block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left']) }}
                        {{ Form::text('rating', $dish->rating, ['class' => 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500' . ($errors->has('rating') ? ' is-invalid' : ''), 'placeholder' => 'Valorizacion']) }}
                        {!! $errors->first('rating', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    <div class="col-span-2 pt-5">
                        {{ Form::label('Tiempo de preparacion', null, ['class' => 'block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left']) }}
                        {{ Form::text('prep_time', $dish->prep_time, ['class' => 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500' . ($errors->has('prep_time') ? ' is-invalid' : ''), 'placeholder' => 'Tiempo de preparacion']) }}
                        {!! $errors->first('prep_time', '<div class="invalid-feedback">:message</div>') !!}
                    </div>
                    <div class="col-span-2 pt-5">
                        {{ Form::label('Imagen', 'Imagen', ['class' => 'block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left']) }}
                    ...
                    <div class="col-span-2 pt-5">
                        ...
                        {{ Form::select('type_id', $types, $dish->type_id, ['class' => 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500' . ($errors->has('type_id') ? ' is-invalid' : ''), 'placeholder' => 'Seleccionar']) }}
