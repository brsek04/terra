...
@section('content')
    <div class="bg-white dark:bg-gray-800 shadow-md sm:rounded-lg">
        <h3 class="text-gray-700 font-bold p-3 dark:text-white"> {{ __('Sucursal') }}</h3>
    </div>
    ...
    <div class="shadow-md rounded-lg pt-4 min-h">
        ...
        <div class="overflow-x-auto">
            <table  class="w-full p-9 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                @include('branch.modal.delete')
                @include('branch.modal.show')
                @endforeach 
                </tbody>
            </table>
        </div>
