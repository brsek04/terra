    ...
    <div class="shadow-md rounded-lg pt-4 min-h">
        ...
        <div class="overflow-x-auto">
            <table  class="w-full p-9 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                @include('beverage-type.modal.edit')
                @include('beverage-type.modal.delete')
                @include('beverage-type.modal.show')
                @endforeach 
                </tbody>
            </table>
        </div>
...
@include('beverage-type.modal.create')
@endsection
