...
<section class="">
    <div class="section-header  bg-white dark:bg-gray-800 shadow-md sm:rounded-lg">
            <h3 class="text-gray-600 font-bold  dark:text-white p-3 ">Permisos y Roles</h3>
    </div>
    ...
    <div class=" shadow-md rounded-lg pt-4 min-h ">
        <div class="flex bg-white pt-2 px-2 flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4 dark:bg-gray-800">
            <div class="pt-1 px-4">
                @can('crear-rol')
                <button type="button" class="flex-inline text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:from-cyan-500 dark:to-blue-500  dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2 text-center me-2 mb-2">
                    <a href="#" data-modal-toggle="modal-create" data-modal-target="modal-create"> Nuevo Rol</a>
                </button>
                @endcan
            </div>
        </div>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-4 text-center">
                        ...
                        <button type="button" class="text-cyan-700 hover:text-white border border-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm p-2 text-center me-2 mb-2 dark:border-cyan-500 dark:text-cyan-500 dark:hover:text-white dark:hover:bg-cyan-600 dark:focus:ring-cyan-800">
                            <a href="{{ route('roles.edit', $role->id) }}" class="flex items-center">
