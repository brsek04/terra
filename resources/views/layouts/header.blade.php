          ...
          <div class="flex items-center">
              <div class="flex items-center ms-3">
                  ...
                  <div class="relative pr-4">
                      <button id="user-menu-button" aria-expanded="true" aria-haspopup="true" class="flex items-center justify-center h-8 w-8 bg-gray-500 rounded-full text-white">
                          <span class="sr-only">Open user menu</span>
                          {{ strtoupper(substr(\Illuminate\Support\Facades\Auth::user()->name, 0, 1)) }}
                      </button>
                      <div id="dropdown-user" class="z-50 hidden origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                          ...
                          <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Earnings</a>
                          <a href="{{ route('logout') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-3" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Sign out</a>
